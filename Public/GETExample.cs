      ...
      //  private static readonly bool DebuggingSubProcess = Debugger.IsAttached;
        ...
        public static void Init(AbstractCefSettings settings, IBrowserProcessHandler browserProcessHandler)
        {
           ...
           // settings.CefCommandLineArgs.Add("allow-running-insecure-content", "1"); //By default, an https page cannot run JavaScript, CSS or plugins from http URLs. This provides an override to get the old insecure behavior. Only available in 47 and above.
            ...
            bool DebuggingSubProcess = false;
            ...
            settings.RegisterScheme(new CefCustomScheme
            {
                ...
                SchemeHandlerFactory = new FolderSchemeHandlerFactory(rootFolder: @"..\..\..\..\Resources", //@"..\..\..\..\CefSharp.Example\Resources",
                                                                    ...
                                                                    defaultPage: "other_tests.html") //Optional param will default to index.html
            });
        ...
        public static async void RegisterTestResources(IWebBrowser ChromiumWebBrowser)
        {
            var handler = ChromiumWebBrowser.ResourceHandlerFactory as DefaultResourceHandlerFactory;
            if (handler != null)
            {
