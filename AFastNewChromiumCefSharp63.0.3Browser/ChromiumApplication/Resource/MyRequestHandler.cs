...
namespace ChromiumApplication
{
    public class MyRequestHandler : IRequestHandler
    {
        ...
        public bool IRequestHandler(IWebBrowser browserControl, IBrowser browser, bool isProxy, string host, int port, X509Certificate2Collection certificates, ISelectClientCertificateCallback callback)
        {
